...
+(void)handleHttpRequest:(HHZHttpRequest *)request
{
    ...
    {
        [[HHZHttpManager shareManager].requestSerializer setValue:request.headerDic[key] forHTTPHeaderField:key];
    }
}
...
+(void)addHttpHeaders:(HHZHttpRequestCondition *)condition
{
    ...
    {
        [[HHZHttpManager shareManager].requestSerializer setValue:condition.headersDic[key] forHTTPHeaderField:key];
    }
}
